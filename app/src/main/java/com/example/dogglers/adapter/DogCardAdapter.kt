...
class DogCardAdapter(
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.imageView?.setImageResource(dogInfo.imageResourceId)
        holder.textViewName?.text = dogInfo.name

        //resources.getString(R.string.dog_hobbies, "Chasing sea foam")
        ...
        holder.textViewAge?.text = resources?.getString(R.string.dog_age, dogInfo.age)
        holder.textViewHobby?.text = resources?.getString(R.string.dog_hobbies, dogInfo.hobbies)
    }
}
